...
plt.scatter(Data[:, 0], Data[:, 1], marker='o',c = 'black', label='Simulated Data')
plt.xlabel('X')
plt.ylabel('Y')
#plt.legend()
#plt.grid()
...
plt.figure(figsize=(6, 6))
plt.scatter(result['X'], result['Y'], marker='o',c = 'black', label='PAV Result')
plt.plot(result['X'], result['Y_hat'], color='darkgray', linewidth=2.5, label='Regression Line')
plt.xlabel('X')
plt.ylabel('Y')
#plt.legend()
#plt.grid()
